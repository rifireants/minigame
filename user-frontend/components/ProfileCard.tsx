...
const ProfileCard = ({ name, id, level, points }: ProfileCardProps) => {
  return (
    <div className="p-6 border-b border-[#e9ecef]">
      ...
      <div className="flex items-center gap-4 mb-5">
        ...
        <div className="flex-1">
          <h2 className="text-lg font-bold text-[#333] mb-1">{name}</h2>
          <p className="text-sm text-[#6c757d] mb-2">ID: {id}</p>
      ...
      <div className="bg-gradient-to-br from-[#667eea] to-[#764ba2] text-white p-5 rounded-lg text-center shadow-xl">
        ...
        <div className="text-4xl font-extrabold mb-4">{points}P</div>
